		...
		<div class="account-left">
			...
			<div class="account-right">
				...
				<div class="registration_form">
					<form id="registration_form" action="<%=request.getContextPath()%>/design/registerServlet.do?method=login" method="post">
						<div>
						<input placeholder="用户名" type="text" name="name" tabindex="1">
						</div>
						<div>
						<input placeholder="密码" type="password" name="password" tabindex="2">
						</div>	
